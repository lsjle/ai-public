...
#use Two-Class Boosted Decision Tree to fit the model
...
base_tree = DecisionTreeClassifier(max_depth=3)  # You can adjust the max_depth parameter
model = AdaBoostClassifier(base_tree, n_estimators=50, random_state=42)
# Train the model
...
sumbitdf.to_csv('for_submission_2023113005.csv', index=False)
from sklearn.metrics import accuracy_score
